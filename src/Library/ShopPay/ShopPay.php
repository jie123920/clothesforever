...
class  ShopPay extends Common{
    ...
    public function promotion(){
        return $this->shop->shopInfo('order-new/promotion');
    }
     ...
     */
    public function verifyByCode($uid, $code, $categories, $type){
     ...
     */
    public function createOrder($uid, $lang, $address_id, $payment_country_id, $channel_id, $trans_type, $products, $remark, $coupon_code, $device = 'pc') {
