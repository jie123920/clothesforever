...
abstract class Common{
    private $baseurl = array(
        'dev' => 'http://devucenter.clothesforever.com',
        'qa' => 'http://testucenter.clothesforever.com',
        'prod' => 'http://ucenter.clothesforever.com',
    );
    public $env = 'prod';
    public $url = null;
    public $domain = 'clothesforever.com';
    ...
    public function __construct( array $params=array() ){
        ...
        $this->domain = 'clothesforever.com';
