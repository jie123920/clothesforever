...
//            }
    ...
    public function actionBindfacebookcallback()
    {
        ...
        $result = $userCenter->bindfb(null, $userData['id'], $_SESSION['fb_access_token'],'clothesforever');
...
//            echo "<pre>";
    ...
    public function actionBindgooglecallback()
    {
        ...
        $result = $userCenter->bindgg(null, $userData['id'], $code,'clothesforever',\Yii::$app->params['MY_URL']['CF']."/");
    ...
    public function actionLogin(){
        ...
        return $this->render('/usercenter/login.html', [
        ]);
    }
