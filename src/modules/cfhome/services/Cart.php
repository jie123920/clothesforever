...
class Cart extends Service
{
     ...
     * @param $uid
     */
    public function addCart($shop_id, $item_id, $number, $uid)
    {
        $params = ['shop_id' => $shop_id, 'item_id' => $item_id, 'number' => $number, 'uid' => $uid];
        $params = self::encode($params);
        $result = myhelper::sendRequest($params, 'POST', true, LC_SHOP_API_URL . 'cart/add-item');
        return $result;
    }
    ...
    public function updateCart($shop_id, $item_id, $number, $uid)
    {
        $params = ['shop_id' => $shop_id, 'item_id' => $item_id, 'number' => $number, 'uid' => $uid];
        $params = self::encode($params);
        $result = myhelper::sendRequest($params, 'POST', true, LC_SHOP_API_URL . 'cart/update-item');
        return $result;
    }
    ...
    public function deleteCart($shop_id, $item_id, $uid)
    {
        ...
        $params = self::encode($params);
        $result = myhelper::sendRequest($params, 'POST', true, LC_SHOP_API_URL . 'cart/delete-item');
        return $result;
    }
    ...
    public function cartDbList($shop_id, $lang, $uid)
    {
        ...
        $params = self::encode($params);
        $result = myhelper::sendRequest($params, 'POST', true, LC_SHOP_API_URL . 'cart/get-db-cart');
    ...
    public function cartCookieList($shop_id, $lang, $items = '')
    {
        ...
        $params = self::encode($params);
        $result = myhelper::sendRequest($params, 'POST', true, LC_SHOP_API_URL . 'cart/get-cookie-cart');
        return isset($result['data']) ? $result['data'] : [];
    }
    ...
    public function cartCount($shop_id, $uid)
    {
        ...
        $params = self::encode($params);
        $result = myhelper::sendRequest($params, 'POST', true, LC_SHOP_API_URL . 'cart/get-item-number');
    ...
    {
        $params = self::encode([]);
        $result = myhelper::sendRequest($params, 'GET', true, LC_SHOP_API_URL . 'cart/goods-promotion');
        return isset($result['data']) ? $result['data'] : [];
    }
    ...
    public function gtm($goods_sku_id, $number)
    {
        ...
        $params = self::encode($params);
        $result = myhelper::sendRequest($params, 'GET', true, LC_SHOP_API_URL . 'cart/gtm');
    ...
    public function goodsSku($goods_sku_id)
    {
        ...
        $params = self::encode($params);
        $result = myhelper::sendRequest($params, 'GET', true, LC_SHOP_API_URL . 'cart/goods-sku');
        return isset($result['data']) ? $result['data'] : [];
    }
    ...
    public function checkStore($shop_id, $lang, $items)
    {
        ...
        $params = ['shop_id' => $shop_id, 'lang' => $lang, 'items' => $items];
        $params = self::encode($params);
        $result = myhelper::sendRequest($params, 'GET', true, LC_SHOP_API_URL . 'cart/check-store');
        return $result;
    }
}