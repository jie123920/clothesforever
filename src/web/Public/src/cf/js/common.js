...
$(".header_login_box").on("mouseleave", function () {
...
$(".reg_user").on("mouseleave", function () {
    $(".header_register_box").hide().removeClass("css3_fadeIn");
});
$(".header_register_box").on("mouseleave", function () {
...
$("#avater_list li img").bind("click", function() {
    $("#picture_100 img,#picture_50 img").attr({
        "src": $(this).attr("src"),
        "default": 1
    });
});
...
$("#default_avater_save").bind("click", function() {
    if ($("#picture_100 img").attr("default") == 1) {
        $.post(save_portra_url, {
            src: $("#picture_100 img").attr("src")
        }, function(data) {
